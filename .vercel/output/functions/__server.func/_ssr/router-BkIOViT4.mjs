...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BkIOViT4.js
var router_BkIOViT4_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DKnVqiH8.css";
var APP_NAME = "Ivory Hopper";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Jump the keys of a giant concert piano. Learn Chopsticks, Für Elise, and more."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-BT5AVdA7.mjs");
...
//#endregion
export { getRouter, router_BkIOViT4_exports as t };
